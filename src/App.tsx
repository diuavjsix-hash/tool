...
import { Check, Code2, Copy, ShieldCheck, Sigma } from 'lucide-react'
    ...
    <TooltipProvider delayDuration={250}>
      <div className="min-h-screen bg-background text-foreground">
        <header className="border-b border-border/70 bg-background/80 backdrop-blur-xl">
          <div className="mx-auto flex h-16 w-[min(1200px,calc(100%-32px))] items-center justify-between sm:h-[72px]">
            <a href="./" className="flex items-center gap-3 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
              ...
              <span>
                <strong className="block text-sm tracking-[-0.02em]">t·finder</strong>
                <span className="hidden text-[10px] text-muted-foreground sm:block">Student&apos;s t critical value</span>
              </span>
            </a>
            <Button asChild variant="ghost" size="sm">
              <a href="https://github.com/diuavjsix-hash/tool" target="_blank" rel="noreferrer">
                <Code2 size={16} />
        ...
        <main className="mx-auto w-[min(1200px,calc(100%-32px))] pb-12 pt-9 sm:pt-12 lg:pb-20 lg:pt-16">
          ...
          <footer className="mt-5 flex flex-col gap-1 text-[10px] leading-5 text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
            ...
            <span>React · shadcn/ui · TypeScript · Vite</span>
          </footer>
        </main>
      </div>
    </TooltipProvider>
